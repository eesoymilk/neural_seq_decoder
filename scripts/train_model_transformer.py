...
from neural_decoder.transformer_model import TransformerDecoder
...
def trainModel(cfg: DictConfig):
    ...
    elif "transformer" in cfg.modelName.lower():
        print("Initializing Vanilla Transformer Model")
        # Check for transformer specific args in cfg, use defaults if not present
